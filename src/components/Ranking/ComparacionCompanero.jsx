...
export default function ComparacionCompanero() {
  ...
  return (
    <div className="bg-gray-800 rounded-xl p-4 mb-6">
      <h3 className="text-lg font-bold mb-2">Comparación con tu compañero</h3>
      <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
        <div className="bg-blue-900 p-4 rounded-xl w-48 text-center">
          <div className="font-bold text-blue-300">Tú</div>
        ...
        <div className="bg-green-900 p-4 rounded-xl w-48 text-center">
          <div className="font-bold text-green-300">Compañero</div>
