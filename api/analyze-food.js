      ...
      contents: [
        {
          parts: [
            {
              text: `¿Qué comida aparece en la imagen?\nLínea 1: responde solo con el nombre del plato o alimento principal.\nLínea 2: responde solo con una palabra la categoría para una persona que quiere bajar de peso: Muy bien, Bien, Regular, Mal o Muy mal. Sé extremadamente benevolente y positivo en la calificación, destaca siempre lo bueno y da la mejor nota posible salvo que sea claramente insalubre. Si tienes dudas, elige la mejor opción.\nLínea 3: Escribe el título "Explicación:" y luego explica en no más de 2 o 3 líneas por qué le diste esa puntuación, mencionando ingredientes. No repitas el nombre de la comida ni la categoría en la explicación.\nLínea 4: Escribe el título "Tips para mejorar:" y luego da 2 o 3 tips concretos para mejorar la comida y hacerla más saludable para alguien que quiere bajar de peso. No repitas el título.\nSi no puedes identificar la comida, responde "Desconocido" y en la segunda línea "Regular".`
            },
            {
              inline_data: {
